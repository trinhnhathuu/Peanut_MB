...
import 'package:peanut_app/pages/views/user/u_dang_bai/u_dang_bai_controller.dart';
...
class UBaiDangPage extends GetView<UBaiDangController> {
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return GetBuilder(
        init: UBaiDangController(),
        builder: (controller) {
