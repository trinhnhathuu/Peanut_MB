class TaiKhoanRequest {
  ...
  @override
  String toString() {
    return 'TaiKhoanRequest(id: $id, email: $email, userName: $name, password: $password, role: $role, tokenDevice: $tokenDevice, phone: $phone, address: $address, avatar: $avatar, status: $status, verified: $verified, gender: $gender, birthday: $birthday)';
  }
}
